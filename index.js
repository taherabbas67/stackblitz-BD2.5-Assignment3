...
// End point 1
function sortingHotelsByPriceLowToHigh(hotel1, hotel2) {
  return hotel1.price - hotel2.price;
}
function sortingHotelsByPriceHighToLow(hotel1, hotel2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing == 'low-to-high') {
    result.sort(sortingHotelsByPriceLowToHigh);
  } else if (pricing == 'high-to-low') {
    result.sort(sortingHotelsByPriceHighToLow);
  }
  res.json({ hotels: result });
});

// End point 2
function sortingHotelsByRatingLowToHigh(hotel1, hotel2) {
  return hotel1.rating - hotel2.rating;
}
function sortingHotelsByRatingHighToLow(hotel1, hotel2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating == 'low-to-high') {
    result.sort(sortingHotelsByRatingLowToHigh);
  } else if (rating == 'high-to-low') {
    result.sort(sortingHotelsByRatingHighToLow);
  }
  res.json({ hotels: result });
});

// End point 3
function sortingByReviewsLeastToMost(hotel1, hotel2) {
  return hotel1.reviews - hotel2.reviews;
}
function sortingByReviewsMostToLeast(hotel1, hotel2) {
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  if (reviews == 'least-to-most') {
    result.sort(sortingByReviewsLeastToMost);
  } else if (reviews == 'most-to-least') {
    result.sort(sortingByReviewsMostToLeast);
  }
  res.json({ hotels: result });
});
